...
export interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  /** Sets `aria-busy`. Does NOT auto-disable — a cancellable action stays clickable. */
  loading?: boolean;
  fullWidth?: boolean;
}
...
/**
 * Exactly one `primary` per view. `danger` only in a ConfirmDialog footer or a
 * Danger Zone; elsewhere destructive actions are `danger-ghost` in a menu.
 */
